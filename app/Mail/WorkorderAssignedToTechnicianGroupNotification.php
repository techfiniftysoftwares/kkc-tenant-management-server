...
class WorkorderAssignedToTechnicianGroupNotification extends Mailable
{
    ...
    public function __construct(WorkOrder $workOrder, TechnicianGroup $technicianGroup, User $technician)
    {
    ...
    {
        return $this->subject('New Workorder Assigned to Your Group: ' . $this->workOrder->work_order_number)
            ->markdown('emails.workorders.assigned-to-technician-group');
    }
